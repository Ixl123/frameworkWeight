...
// import { loadState, saveState } from './localStorage'; accessibility var a11y
// = require('react-a11y'); import throttle to only run save state function
// only once a second
...
// only write to localstorage once a second store.subscribe(throttle(() => {
